...
public class SchedulePage extends AndriodGestures {
	...
	public void selectClass() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@text='ramesh - A']")).click();
	//	driver.findElement(By.xpath("6353 class - ABC")).click();
		Thread.sleep(3000);
		System.out.println("The selected class is ramesh - A ...");
	...
	public void selectTeacher() throws InterruptedException {
		...
		driver.hideKeyboard();
		Thread.sleep(3000);
		driver.findElement(By.xpath("//*[@text=' VAnzyosURq']")).click();
		Thread.sleep(3000);
		System.out.println("The selected teacher Name is : VAnzyosURq");
