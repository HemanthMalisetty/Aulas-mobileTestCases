...
public SchedulePage SP;
	...
	public SchedulePage clickOnScheduleButton() throws InterruptedException {
		...
		//driver.findElement(By.xpath("//android.widget.Button[@content-desc="Schedule, tab, 1 of 4"]/android.widget.TextView[2]")).click();
	...
	public AttendancePage clickOnAttendace() throws InterruptedException {
		Thread.sleep(3000);
		driver.findElement(By.xpath("//*[@text='Attendance']")).click();
		System.out.println("Clicked on attendance page...!");
